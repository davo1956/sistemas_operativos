...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\footnotesize Sistemas Operativos} %encabezado izquierda
\fancyhead[R]{\footnotesize David Pérez Jacome\\ Víctor Rosales Jaimes}   % derecha
...
\begin{center}
  ...
  \begin{minipage}{0.52\textwidth}
    \begin{flushleft} \large \small \vspace{-0.6cm} \vspace{-0.6cm}
      ...
      \emph{Numero de cuenta:} 316330420\\ \vspace*{.5cm}
      Alumno: Víctor Rosales Jaimes \\
      \emph{Número de cuenta:} 316084501 \\ \vspace*{2cm}
    \end{flushleft}
  \end{minipage}
